...
export const menuItems = cva(
  'transition ease-out duration-100 transform absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white dark:bg-zinc-900 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'
);

export const menuItem = cva(
  'block px-4 py-2 text-sm text-gray-700 dark:text-white dark:hover:bg-zinc-800'
);
