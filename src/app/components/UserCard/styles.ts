...
export const container = cva(
  'relative w-[400px] h-[420px] items-center justify-center  bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 rounded overflow-hidden shadow-lg px-6 py-4'
);
